...
namespace hubu
{
    public partial class showCourseInfo : System.Web.UI.Page
    {
        ...
        {
            string str = "Data Source=HD149PC;Initial Catalog=hubu;Integrated Security=True";

            SqlConnection myConnection = new SqlConnection(str);

            myConnection.Open();

            string select = "select * from Course where Cname like '%" + TextBox1.Text + "%'";
